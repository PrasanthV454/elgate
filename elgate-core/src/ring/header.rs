...
pub struct RingHeader {
    ...
    /// NUMA node where this ring buffer is preferentially allocated.
...
impl RingHeader {
    ...
    pub fn new(size: usize, slot_size: usize) -> Self {
        ...
        Self {
            ...
            numa_node: AtomicU32::new(0), // Default to node 0
    ...
    /// Gets the NUMA node for this ring buffer.
...
mod tests {
    ...
    fn test_header_creation() {
        ...
        assert_eq!(
            header.slot_count.load(Ordering::Relaxed),
            expected_slot_count
        );
